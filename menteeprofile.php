			...
			<div class="user_profile">
				...
				<div class="infotable">
					...
					<div class="tabcontentstyle">
						...
						<br>
						<?php $sql = "SELECT * FROM mentorwebdb.endorsements WHERE EndorsedID=".$_GET['id']." AND EndorsedAccountType=2 ORDER BY EndorsementTimeStamp DESC;";
							$result = mysql_query($sql,$con);
							while($row = mysql_fetch_array($result)) { ?>
							<table align='center' width='95%' cellpadding='10px' border='1' style='border-collapse:collapse; border: dotted;'>
						<?php		$sql2 = "SELECT AVG(Rating) as AvgRating FROM mentorwebdb.endorsements WHERE EndorsedID=".$_GET['id']." AND EndorsedAccountType=2;";
					...
					<?php } ?>
						...
						<form method="POST" action="send_email.php">
							...
							<input name="recepientAccountType" type="text"  value="2" hidden/>
						</form>
						</td></tr>
						</table>
						</div>
