...
<head>
	...
	<script>
	function sortby(str) {
	  var url = "mentorsearch.php?sortby="+str;
	  window.location = url;
	}
	</script>
	<!-- <script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyDIxo3qlpEN0SDQHSEFXHYxyeO-1TefwQw&sensor=false"></script> -->
</head>
<body>
...
<!-- CONTENT -->
	<div id="content">
		<div class="container">
		<?php if($_SESSION['user_account_login'] == 2) { ?> <!-- If user is logged in as a mentee -->
			<!-- search box -->
			...
			<div class="search_results">
				...
				<?php include('usersearchresults.php'); ?>
					<text><?php echo $resultsCount; ?> mentors</text>
				...
				<div class="result_table">
					...
					?>
					<div id="profilepic">
						<a href="mentorprofile.php?id=<?php echo $UserID;?>"><img src="<?php echo $ProfilePic;?>"/></a>
					</div>
					<div id="info">
						<text><a href="mentorprofile.php?id=<?php echo $UserID;?>"><?php echo $FirstName . " " . $LastName;?></a></text>
					...
					<div id="ratings">
						<a href="mentorprofile.php?id=<?php echo $UserID;?>"><?php echo $EndorsementCount;?> endorsements</a><br>
						<hr>
						<form method="post" action="mentorprofile.php?id=<?php echo $UserID;?>">
							<div class="rating2">
					<?php if($AvgRating >= 5) {?>
				...
				<div class="page_changer">
					<div id="list">
						...
						<li><a href="mentorsearch.php?page=<?php echo $i."&sortby=".$sortby; ?>"><?php echo $i; ?></a></li>
							<?php if($i > 5) { ?>
								<li><a href="mentorsearch.php?page=6">>></a></li>
							<?php } ?>
						<?php } ?>
						</ul>
					</div>
		...
		<?php } elseif($_SESSION['user_account_type'] == 3) { ?> <!-- Else if user is logged in as a mentee with dual mentor membership -->
			<h3 style="text-align: center;">You are signed in as a Mentor. Logout and sign in to your Mentee account to search for Mentors.</h3><br>
		...
		<?php } elseif($_SESSION['user_account_login'] == 1) { ?> <!-- Else if user is logged in as a mentor -->
			<h3 style="text-align: center;">You are registered only as a Mentor. You may register for a dual, Mentor-Mentee membership.</h3><br>
