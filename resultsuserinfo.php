...
$con = mysql_connect(DB_HOST, DB_USER, DB_PASS, DB_NAME);
	if($_SESSION['user_account_login'] == 2) {
		$sql1 = "SELECT * FROM mentorwebdb.mentor_personal_info WHERE ID=" . $_GET['id'] . ";";
		$sql2 = "SELECT * FROM mentorwebdb.mentor_career_info WHERE ID=" . $_GET['id'] . ";";
		$result1 = mysql_query($sql1,$con);
		$result2 = mysql_query($sql2,$con);
	} elseif($_SESSION['user_account_login'] == 1) {
		$sql1 = "SELECT * FROM mentorwebdb.mentee_personal_info WHERE ID=" . $_GET['id'] . ";";
		$sql2 = "SELECT * FROM mentorwebdb.mentee_career_info WHERE ID=" . $_GET['id'] . ";";
		$result1 = mysql_query($sql1,$con);
		$result2 = mysql_query($sql2,$con);
	}
