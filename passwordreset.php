	...
	<div id="content">
		<div class="container">
			...
			<div class="register">
				...
				<tr>
					<td colspan='2'>
					<input class="textbox2" id="user_password_new" type="password" name="user_password_new" pattern=".{6,}" placeholder="New password (6 or more characters)" 
						tabindex="8" required autocomplete="off" />
					</td>
				</tr>
				<tr>
					<td colspan='2'>
					<input class="textbox2" id="user_password_repeat" type="password" name="user_password_repeat" pattern=".{6,}"  placeholder="Repeat new password" 
				...
				<tr>
					<td>
					<input id="submit_button" type="submit"  name="reset_password" value="Reset password" tabindex="11" />
					</td>
				</tr>
				</table>
				</form>
